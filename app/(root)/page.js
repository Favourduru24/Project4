...
import CategoryFilter from "@/components/shared/CategoryFilter";
   ...
   export default async function Home ({searchParams}) {
    ...
    const category = (searchParams?.category) || ''
     ...
     return (
        <>
         <section className="bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10 max-xl:px-10 px-5">
          ...
          <section id="events" className="wrapper my-8 flex flex-col gap-8 md:gap-12 max-xl:px-10 px-5">
